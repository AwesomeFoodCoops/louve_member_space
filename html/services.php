...
<div class="row">
		...
		<div class="col-xs-12 col-sm-6">
               ...
               <a href="#"><!--<a href="produits.php">-->
			   <button class="btn btn-default" style="border-color : red; color : red;"><span class="glyphicon glyphicon-apple"></span> Prochainement ici</button>
			   </a>
            </div>
        </div>
		...
		<div class="col-xs-12 col-sm-6">
				...
				<a href="#"><!--<a href="formbureau.php">-->
           <button class="btn btn-default" style="border-color : red; color : red;" ><span class="glyphicon glyphicon-pencil"></span> Prochainement ici </button>
			</a>
            </div>
        </div>
		</div>
<div class="row">
		...
		<div class="col-xs-12 col-sm-6">
                   <div class="louve-creneau" style="backgr-color : #FED8CF;">
                 <h3><strong>Foire aux questions</strong></h3>
                <p> Trouvez toutes les réponses ou presque à vos questions. </p>
                <button class="btn btn-default" style="border-color : red; color : red;"><span class="glyphicon glyphicon-ok"></span> Prochainement ici.</button>
            </div>
        </div>
