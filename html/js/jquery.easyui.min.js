...
},loader:function(_a91,_a92,_a93){
var opts=$(this).combobox("options");
if(!opts.url){
return false;
}
$.ajax({type:opts.method,url:opts.url,data:_a91,dataType:"json",success:function(data){
_a92(data);
},error:function(){
_a93.apply(this,arguments);
}});
},loadFilter:function(data){
return data;
},finder:{getEl:function(_a94,_a95){
var _a96=_a3b(_a94,_a95);
var id=$.data(_a94,"combobox").itemIdPrefix+"_"+_a96;
return $("#"+id);
},getGroupEl:function(_a97,_a98){
var _a99=$.data(_a97,"combobox");
var _a9a=$.easyui.indexOfArray(_a99.groups,"value",_a98);
var id=_a99.groupIdPrefix+"_"+_a9a;
return $("#"+id);
},getGroup:function(_a9b,p){
var _a9c=$.data(_a9b,"combobox");
var _a9d=p.attr("id").substr(_a9c.groupIdPrefix.length+1);
return _a9c.groups[parseInt(_a9d)];
},getRow:function(_a9e,p){
var _a9f=$.data(_a9e,"combobox");
var _aa0=(p instanceof $)?p.attr("id").substr(_a9f.itemIdPrefix.length+1):_a3b(_a9e,p);
return _a9f.data[parseInt(_aa0)];
}},onBeforeLoad:function(_aa1){
},onLoadSuccess:function(data){
},onLoadError:function(){
},onSelect:function(_aa2){
},onUnselect:function(_aa3){
}});
})(jQuery);
(function($){
function _aa4(_aa5){
var _aa6=$.data(_aa5,"combotree");
var opts=_aa6.options;
var tree=_aa6.tree;
$(_aa5).addClass("combotree-f");
$(_aa5).combo($.extend({},opts,{onShowPanel:function(){
if(opts.editable){
tree.tree("doFilter","");
}
opts.onShowPanel.call(this);
}}));
var _aa7=$(_aa5).combo("panel");
if(!tree){
tree=$("<ul></ul>").appendTo(_aa7);
_aa6.tree=tree;
}
tree.tree($.extend({},opts,{checkbox:opts.multiple,onLoadSuccess:function(node,data){
var _aa8=$(_aa5).combotree("getValues");
if(opts.multiple){
$.map(tree.tree("getChecked"),function(node){
$.easyui.addArrayItem(_aa8,node.id);
});
}
_aad(_aa5,_aa8,_aa6.remainText);
...
},onCheck:function(node,_aa9){
_aa6.remainText=false;
_aaa(_aa5);
opts.onCheck.call(this,node,_aa9);
}}));
};
function _aaa(_aab){
...
_aad(_aab,vv,_aac.remainText);
};
function _aad(_aae,_aaf,_ab0){
var _ab1=$.data(_aae,"combotree");
var opts=_ab1.options;
var tree=_ab1.tree;
var _ab2=tree.tree("options");
var _ab3=_ab2.onBeforeCheck;
var _ab4=_ab2.onCheck;
var _ab5=_ab2.onSelect;
_ab2.onBeforeCheck=_ab2.onCheck=_ab2.onSelect=function(){
};
if(!$.isArray(_aaf)){
_aaf=_aaf.split(opts.separator);
}
if(!opts.multiple){
_aaf=_aaf.length?[_aaf[0]]:[""];
}
var vv=$.map(_aaf,function(_ab6){
return String(_ab6);
});
...
ss.push(_ab7(v,opts.mappingRows)||v);
...
_ab2.onBeforeCheck=_ab3;
_ab2.onCheck=_ab4;
_ab2.onSelect=_ab5;
if(!_ab0){
var s=ss.join(opts.separator);
if($(_aae).combo("getText")!=s){
$(_aae).combo("setText",s);
}
}
$(_aae).combo("setValues",vv);
function _ab7(_ab8,a){
var item=$.easyui.getArrayItem(a,"id",_ab8);
return item?item.text:undefined;
};
};
function _ab9(_aba,q){
var _abb=$.data(_aba,"combotree");
var opts=_abb.options;
var tree=_abb.tree;
_abb.remainText=true;
tree.tree("doFilter",opts.multiple?q.split(opts.separator):q);
};
function _abc(_abd){
var _abe=$.data(_abd,"combotree");
_abe.remainText=false;
$(_abd).combotree("setValues",$(_abd).combotree("getValues"));
$(_abd).combotree("hidePanel");
};
$.fn.combotree=function(_abf,_ac0){
if(typeof _abf=="string"){
var _ac1=$.fn.combotree.methods[_abf];
if(_ac1){
return _ac1(this,_ac0);
}else{
return this.combo(_abf,_ac0);
}
}
_abf=_abf||{};
return this.each(function(){
var _ac2=$.data(this,"combotree");
if(_ac2){
$.extend(_ac2.options,_abf);
}else{
$.data(this,"combotree",{options:$.extend({},$.fn.combotree.defaults,$.fn.combotree.parseOptions(this),_abf)});
}
_aa4(this);
});
};
$.fn.combotree.methods={options:function(jq){
var _ac3=jq.combo("options");
return $.extend($.data(jq[0],"combotree").options,{width:_ac3.width,height:_ac3.height,originalValue:_ac3.originalValue,disabled:_ac3.disabled,readonly:_ac3.readonly});
},clone:function(jq,_ac4){
var t=jq.combo("clone",_ac4);
...
if($.isArray(_ac5)){
_ac5=$.map(_ac5,function(_ac6){
if(_ac6&&typeof _ac6=="object"){
$.easyui.addArrayItem(opts.mappingRows,"id",_ac6);
return _ac6.id;
}else{
return _ac6;
}
...
},setValue:function(jq,_ac7){
return jq.each(function(){
$(this).combotree("setValues",$.isArray(_ac7)?_ac7:[_ac7]);
});
},clear:function(jq){
return jq.each(function(){
...
$.fn.combotree.parseOptions=function(_ac8){
return $.extend({},$.fn.combo.parseOptions(_ac8),$.fn.tree.parseOptions(_ac8));
};
...
(function($){
function _ac9(_aca){
var _acb=$.data(_aca,"combogrid");
var opts=_acb.options;
var grid=_acb.grid;
$(_aca).addClass("combogrid-f").combo($.extend({},opts,{onShowPanel:function(){
_ae0(this,$(this).combogrid("getValues"),true);
var p=$(this).combogrid("panel");
var _acc=p.outerHeight()-p.height();
var _acd=p._size("minHeight");
var _ace=p._size("maxHeight");
var dg=$(this).combogrid("grid");
dg.datagrid("resize",{width:"100%",height:(isNaN(parseInt(opts.panelHeight))?"auto":"100%"),minHeight:(_acd?_acd-_acc:""),maxHeight:(_ace?_ace-_acc:"")});
...
var _acf=$(_aca).combo("panel");
if(!grid){
grid=$("<table></table>").appendTo(_acf);
_acb.grid=grid;
}
grid.datagrid($.extend({},opts,{border:false,singleSelect:(!opts.multiple),onLoadSuccess:_ad0,onClickRow:_ad1,onSelect:_ad2("onSelect"),onUnselect:_ad2("onUnselect"),onSelectAll:_ad2("onSelectAll"),onUnselectAll:_ad2("onUnselectAll")}));
function _ad3(dg){
return $(dg).closest(".combo-panel").panel("options").comboTarget||_aca;
};
function _ad0(data){
var _ad4=_ad3(this);
var _ad5=$(_ad4).data("combogrid");
var opts=_ad5.options;
var _ad6=$(_ad4).combo("getValues");
_ae0(_ad4,_ad6,_ad5.remainText);
opts.onLoadSuccess.call(this,data);
};
function _ad1(_ad7,row){
var _ad8=_ad3(this);
var _ad9=$(_ad8).data("combogrid");
var opts=_ad9.options;
_ad9.remainText=false;
_ada.call(this);
if(!opts.multiple){
$(_ad8).combo("hidePanel");
}
opts.onClickRow.call(this,_ad7,row);
};
function _ad2(_adb){
return function(_adc,row){
var _add=_ad3(this);
var opts=$(_add).combogrid("options");
if(_adb=="onUnselectAll"){
if(opts.multiple){
_ada.call(this);
}
}else{
...
opts[_adb].call(this,_adc,row);
};
};
function _ada(){
var dg=$(this);
var _ade=_ad3(dg);
var _adf=$(_ade).data("combogrid");
var opts=_adf.options;
var vv=$.map(dg.datagrid("getSelections"),function(row){
return row[opts.idField];
});
vv=vv.concat(opts.unselectedValues);
_ae0(_ade,vv,_adf.remainText);
};
};
function nav(_ae1,dir){
var _ae2=$.data(_ae1,"combogrid");
var opts=_ae2.options;
var grid=_ae2.grid;
var _ae3=grid.datagrid("getRows").length;
if(!_ae3){
return;
}
...
var _ae4;
if(!tr.length){
_ae4=(dir=="next"?0:_ae3-1);
}else{
var _ae4=parseInt(tr.attr("datagrid-row-index"));
_ae4+=(dir=="next"?1:-1);
if(_ae4<0){
_ae4=_ae3-1;
}
...
grid.datagrid("highlightRow",_ae4);
if(opts.selectOnNavigation){
_ae2.remainText=false;
grid.datagrid("selectRow",_ae4);
}
};
function _ae0(_ae5,_ae6,_ae7){
var _ae8=$.data(_ae5,"combogrid");
var opts=_ae8.options;
var grid=_ae8.grid;
var _ae9=$(_ae5).combo("getValues");
var _aea=$(_ae5).combo("options");
var _aeb=_aea.onChange;
_aea.onChange=function(){
};
var _aec=grid.datagrid("options");
var _aed=_aec.onSelect;
var _aee=_aec.onUnselectAll;
_aec.onSelect=_aec.onUnselectAll=function(){
};
if(!$.isArray(_ae6)){
...
var vv=$.map(_ae6,function(_aef){
return String(_aef);
});
vv=$.grep(vv,function(v,_af0){
return _af0===$.inArray(v,vv);
});
var _af1=$.grep(grid.datagrid("getSelections"),function(row,_af2){
return $.inArray(String(row[opts.idField]),vv)>=0;
});
grid.datagrid("clearSelections");
grid.data("datagrid").selectedRows=_af1;
var ss=[];
opts.unselectedValues=[];
$.map(vv,function(v){
var _af3=grid.datagrid("getRowIndex",v);
if(_af3>=0){
grid.datagrid("selectRow",_af3);
}else{
opts.unselectedValues.push(v);
}
ss.push(_af4(v,grid.datagrid("getRows"))||_af4(v,_af1)||_af4(v,opts.mappingRows)||v);
});
$(_ae5).combo("setValues",_ae9);
_aea.onChange=_aeb;
_aec.onSelect=_aed;
_aec.onUnselectAll=_aee;
if(!_ae7){
var s=ss.join(opts.separator);
...
$(_ae5).combo("setValues",_ae6);
function _af4(_af5,a){
var item=$.easyui.getArrayItem(a,opts.idField,_af5);
return item?item[opts.textField]:undefined;
};
};
function _af6(_af7,q){
var _af8=$.data(_af7,"combogrid");
var opts=_af8.options;
var grid=_af8.grid;
_af8.remainText=true;
var qq=opts.multiple?q.split(opts.separator):[q];
...
q=$.trim(q);
var _afa=q;
_afb(opts.mappingRows,q);
_afb(grid.datagrid("getSelections"),q);
var _afc=_afb(rows,q);
if(_afc>=0){
if(opts.reversed){
grid.datagrid("highlightRow",_afc);
}
}else{
$.map(rows,function(row,i){
if(opts.filter.call(_af7,q,row)){
...
if(tr.length){
var _b00=parseInt(tr.attr("datagrid-row-index"));
if(opts.multiple){
if(tr.hasClass("datagrid-row-selected")){
grid.datagrid("unselectRow",_b00);
}else{
grid.datagrid("selectRow",_b00);
}
}else{
grid.datagrid("selectRow",_b00);
}
...
$(_afe).combogrid("setValues",vv);
if(!opts.multiple){
$(_afe).combogrid("hidePanel");
}
};
$.fn.combogrid=function(_b01,_b02){
if(typeof _b01=="string"){
var _b03=$.fn.combogrid.methods[_b01];
if(_b03){
return _b03(this,_b02);
}else{
return this.combo(_b01,_b02);
}
}
_b01=_b01||{};
return this.each(function(){
var _b04=$.data(this,"combogrid");
if(_b04){
$.extend(_b04.options,_b01);
}else{
_b04=$.data(this,"combogrid",{options:$.extend({},$.fn.combogrid.defaults,$.fn.combogrid.parseOptions(this),_b01)});
}
_ac9(this);
});
};
$.fn.combogrid.methods={options:function(jq){
var _b05=jq.combo("options");
return $.extend($.data(jq[0],"combogrid").options,{width:_b05.width,height:_b05.height,originalValue:_b05.originalValue,disabled:_b05.disabled,readonly:_b05.readonly});
},cloneFrom:function(jq,from){
return jq.each(function(){
$(this).combo("cloneFrom",from);
...
},setValues:function(jq,_b06){
return jq.each(function(){
var opts=$(this).combogrid("options");
if($.isArray(_b06)){
_b06=$.map(_b06,function(_b07){
if(_b07&&typeof _b07=="object"){
$.easyui.addArrayItem(opts.mappingRows,opts.idField,_b07);
return _b07[opts.idField];
}else{
return _b07;
}
});
...
},setValue:function(jq,_b08){
return jq.each(function(){
$(this).combogrid("setValues",$.isArray(_b08)?_b08:[_b08]);
});
},clear:function(jq){
return jq.each(function(){
...
$.fn.combogrid.parseOptions=function(_b09){
var t=$(_b09);
return $.extend({},$.fn.combo.parseOptions(_b09),$.fn.datagrid.parseOptions(_b09),$.parser.parseOptions(_b09,["idField","textField","mode"]));
};
...
var _b0a=e.data.target;
var opts=$(_b0a).combogrid("options");
if(opts.reversed){
$(_b0a).combogrid("setValues",$(_b0a).combogrid("getValues"));
}
...
(function($){
function _b0b(_b0c){
var _b0d=$.data(_b0c,"combotreegrid");
var opts=_b0d.options;
$(_b0c).addClass("combotreegrid-f").combo($.extend({},opts,{onShowPanel:function(){
var p=$(this).combotreegrid("panel");
var _b0e=p.outerHeight()-p.height();
var _b0f=p._size("minHeight");
var _b10=p._size("maxHeight");
var dg=$(this).combotreegrid("grid");
dg.treegrid("resize",{width:"100%",height:(isNaN(parseInt(opts.panelHeight))?"auto":"100%"),minHeight:(_b0f?_b0f-_b0e:""),maxHeight:(_b10?_b10-_b0e:"")});
...
if(!_b0d.grid){
var _b11=$(_b0c).combo("panel");
_b0d.grid=$("<table></table>").appendTo(_b11);
}
_b0d.grid.treegrid($.extend({},opts,{border:false,checkbox:opts.multiple,onLoadSuccess:function(row,data){
var _b12=$(_b0c).combotreegrid("getValues");
if(opts.multiple){
$.map($(this).treegrid("getCheckedNodes"),function(row){
$.easyui.addArrayItem(_b12,row[opts.idField]);
});
}
_b17(_b0c,_b12);
...
$(_b0c).combo("hidePanel");
}
_b14(_b0c);
opts.onClickRow.call(this,row);
},onCheckNode:function(row,_b13){
_b14(_b0c);
opts.onCheckNode.call(this,row,_b13);
}}));
};
function _b14(_b15){
var _b16=$.data(_b15,"combotreegrid");
...
var _b1a=$.data(_b18,"combotreegrid");
...
if(!opts.multiple){
_b19=_b19.length?[_b19[0]]:[""];
}
var vv=$.map(_b19,function(_b1b){
return String(_b1b);
});
vv=$.grep(vv,function(v,_b1c){
return _b1c===$.inArray(v,vv);
});
var _b1d=grid.treegrid("getSelected");
if(_b1d){
grid.treegrid("unselect",_b1d[opts.idField]);
}
...
ss.push(_b1e(v,opts.mappingRows)||v);
opts.unselectedValues.push(v);
}
});
if(opts.multiple){
...
if(!_b1a.remainText){
var s=ss.join(opts.separator);
if($(_b18).combo("getText")!=s){
$(_b18).combo("setText",s);
}
}
$(_b18).combo("setValues",vv);
function _b1e(_b1f,a){
var item=$.easyui.getArrayItem(a,opts.idField,_b1f);
return item?item[opts.treeField]:undefined;
};
};
function _b20(_b21,q){
var _b22=$.data(_b21,"combotreegrid");
var opts=_b22.options;
var grid=_b22.grid;
_b22.remainText=true;
grid.treegrid("clearSelections").treegrid("clearChecked").treegrid("highlightRow",-1);
if(opts.mode=="remote"){
$(_b21).combotreegrid("clear");
...
if(opts.filter.call(_b21,q,row)){
...
$.fn.combotreegrid=function(_b25,_b26){
if(typeof _b25=="string"){
var _b27=$.fn.combotreegrid.methods[_b25];
if(_b27){
return _b27(this,_b26);
}else{
return this.combo(_b25,_b26);
}
}
_b25=_b25||{};
return this.each(function(){
var _b28=$.data(this,"combotreegrid");
if(_b28){
$.extend(_b28.options,_b25);
}else{
_b28=$.data(this,"combotreegrid",{options:$.extend({},$.fn.combotreegrid.defaults,$.fn.combotreegrid.parseOptions(this),_b25)});
}
_b0b(this);
});
};
$.fn.combotreegrid.methods={options:function(jq){
var _b29=jq.combo("options");
return $.extend($.data(jq[0],"combotreegrid").options,{width:_b29.width,height:_b29.height,originalValue:_b29.originalValue,disabled:_b29.disabled,readonly:_b29.readonly});
},grid:function(jq){
...
if($.isArray(_b2a)){
_b2a=$.map(_b2a,function(_b2b){
if(_b2b&&typeof _b2b=="object"){
$.easyui.addArrayItem(opts.mappingRows,opts.idField,_b2b);
return _b2b[opts.idField];
}else{
return _b2b;
}
});
...
},setValue:function(jq,_b2c){
return jq.each(function(){
$(this).combotreegrid("setValues",$.isArray(_b2c)?_b2c:[_b2c]);
});
},clear:function(jq){
return jq.each(function(){
...
$.fn.combotreegrid.parseOptions=function(_b2d){
var t=$(_b2d);
return $.extend({},$.fn.combo.parseOptions(_b2d),$.fn.treegrid.parseOptions(_b2d),$.parser.parseOptions(_b2d,["mode",{limitToGrid:"boolean"}]));
};
...
var _b2e=e.data.target;
var opts=$(_b2e).combotreegrid("options");
if(opts.limitToGrid){
_b23(_b2e);
}
}}),filter:function(q,row){
...
(function($){
function _b2f(_b30){
var _b31=$.data(_b30,"tagbox");
var opts=_b31.options;
$(_b30).addClass("tagbox-f").combobox($.extend({},opts,{cls:"tagbox",reversed:true,onChange:function(_b32,_b33){
_b34();
$(this).combobox("hidePanel");
opts.onChange.call(_b30,_b32,_b33);
},onResizing:function(_b35,_b36){
var _b37=$(this).combobox("textbox");
var tb=$(this).data("textbox").textbox;
tb.css({height:"",paddingLeft:_b37.css("marginLeft"),paddingRight:_b37.css("marginRight")});
_b37.css("margin",0);
tb._size({width:opts.width},$(this).parent());
_b4a(_b30);
_b3c(this);
opts.onResizing.call(_b30,_b35,_b36);
},onLoadSuccess:function(data){
_b34();
...
_b4a(_b30);
function _b34(){
$(_b30).next().find(".tagbox-label").remove();
var _b38=$(_b30).tagbox("textbox");
var ss=[];
$.map($(_b30).tagbox("getValues"),function(_b39,_b3a){
var row=opts.finder.getRow(_b30,_b39);
var text=opts.tagFormatter.call(_b30,_b39,row);
var cs={};
var css=opts.tagStyler.call(_b30,_b39,row)||"";
if(typeof css=="string"){
cs={s:css};
}else{
cs={c:css["class"]||"",s:css["style"]||""};
}
var _b3b=$("<span class=\"tagbox-label\"></span>").insertBefore(_b38).html(text);
_b3b.attr("tagbox-index",_b3a);
_b3b.attr("style",cs.s).addClass(cs.c);
$("<a href=\"javascript:;\" class=\"tagbox-remove\"></a>").appendTo(_b3b);
});
_b3c(_b30);
$(_b30).combobox("setText","");
};
};
function _b3c(_b3d,_b3e){
var span=$(_b3d).next();
var _b3f=_b3e?$(_b3e):span.find(".tagbox-label");
if(_b3f.length){
var _b40=$(_b3d).tagbox("textbox");
var _b41=$(_b3f[0]);
var _b42=_b41.outerHeight(true)-_b41.outerHeight();
var _b43=_b40.outerHeight()-_b42*2;
_b3f.css({height:_b43+"px",lineHeight:_b43+"px"});
var _b44=span.find(".textbox-addon").css("height","100%");
_b44.find(".textbox-icon").css("height","100%");
...
var opts=$(_b46).tagbox("options");
if(opts.disabled||opts.readonly){
return;
}
if($(e.target).hasClass("tagbox-remove")){
var _b47=parseInt($(e.target).parent().attr("tagbox-index"));
var _b48=$(_b46).tagbox("getValues");
if(opts.onBeforeRemoveTag.call(_b46,_b48[_b47])==false){
return;
}
opts.onRemoveTag.call(_b46,_b48[_b47]);
_b48.splice(_b47,1);
$(_b46).tagbox("setValues",_b48);
}else{
var _b49=$(e.target).closest(".tagbox-label");
if(_b49.length){
var _b47=parseInt(_b49.attr("tagbox-index"));
var _b48=$(_b46).tagbox("getValues");
opts.onClickTag.call(_b46,_b48[_b47]);
}
}
...
function _b4a(_b4b){
var opts=$(_b4b).tagbox("options");
var _b4c=$(_b4b).tagbox("textbox");
var span=$(_b4b).next();
var tmp=$("<span></span>").appendTo("body");
tmp.attr("style",_b4c.attr("style"));
tmp.css({position:"absolute",top:-9999,left:-9999,width:"auto",fontFamily:_b4c.css("fontFamily"),fontSize:_b4c.css("fontSize"),fontWeight:_b4c.css("fontWeight"),whiteSpace:"nowrap"});
var _b4d=_b4e(_b4c.val());
var _b4f=_b4e(opts.prompt||"");
tmp.remove();
var _b50=Math.min(Math.max(_b4d,_b4f)+20,span.width());
_b4c._outerWidth(_b50);
span.find(".textbox-button").linkbutton("resize",{height:"100%"});
function _b4e(val){
...
if(!$(_b52).tagbox("isValid")){
return;
}
if(opts.limitToList){
var _b53=t.tagbox("panel");
var item=_b53.children("div.combobox-item-hover");
if(item.length){
item.removeClass("combobox-item-hover");
var row=opts.finder.getRow(_b52,item);
var _b54=row[opts.valueField];
$(_b52).tagbox(item.hasClass("combobox-item-selected")?"unselect":"select",_b54);
}
$(_b52).tagbox("hidePanel");
}else{
var v=$.trim($(_b52).tagbox("getText"));
if(v!==""){
var _b55=$(_b52).tagbox("getValues");
_b55.push(v);
$(_b52).tagbox("setValues",_b55);
}
}
};
function _b56(_b57,_b58){
$(_b57).combobox("setText","");
_b4a(_b57);
$(_b57).combobox("setValues",_b58);
$(_b57).combobox("setText","");
};
$.fn.tagbox=function(_b59,_b5a){
if(typeof _b59=="string"){
var _b5b=$.fn.tagbox.methods[_b59];
if(_b5b){
return _b5b(this,_b5a);
}else{
return this.combobox(_b59,_b5a);
}
}
_b59=_b59||{};
return this.each(function(){
var _b5c=$.data(this,"tagbox");
if(_b5c){
$.extend(_b5c.options,_b59);
}else{
$.data(this,"tagbox",{options:$.extend({},$.fn.tagbox.defaults,$.fn.tagbox.parseOptions(this),_b59)});
}
_b2f(this);
_b45(this);
});
...
var _b5d=jq.combobox("options");
return $.extend($.data(jq[0],"tagbox").options,{width:_b5d.width,height:_b5d.height,originalValue:_b5d.originalValue,disabled:_b5d.disabled,readonly:_b5d.readonly});
},setValues:function(jq,_b5e){
return jq.each(function(){
_b56(this,_b5e);
});
}};
$.fn.tagbox.parseOptions=function(_b5f){
return $.extend({},$.fn.combobox.parseOptions(_b5f),$.parser.parseOptions(_b5f,[]));
};
...
}}),tagFormatter:function(_b61,row){
var opts=$(this).tagbox("options");
return row?row[opts.textField]:_b61;
},tagStyler:function(_b62,row){
return "";
},onClickTag:function(_b63){
},onBeforeRemoveTag:function(_b64){
},onRemoveTag:function(_b65){
}});
})(jQuery);
(function($){
function _b66(_b67){
var _b68=$.data(_b67,"datebox");
var opts=_b68.options;
$(_b67).addClass("datebox-f").combo($.extend({},opts,{onShowPanel:function(){
_b69(this);
_b6a(this);
_b6b(this);
_b79(this,$(this).datebox("getText"),true);
opts.onShowPanel.call(this);
}}));
if(!_b68.calendar){
var _b6c=$(_b67).combo("panel").css("overflow","hidden");
_b6c.panel("options").onBeforeDestroy=function(){
var c=$(this).find(".calendar-shared");
if(c.length){
c.insertBefore(c[0].pholder);
}
};
var cc=$("<div class=\"datebox-calendar-inner\"></div>").prependTo(_b6c);
...
_b68.calendar=$("<div></div>").appendTo(cc).calendar();
}
$.extend(_b68.calendar.calendar("options"),{fit:true,border:false,onSelect:function(date){
var _b6d=this.target;
var opts=$(_b6d).datebox("options");
_b79(_b6d,opts.formatter.call(_b6d,date));
$(_b6d).combo("hidePanel");
opts.onSelect.call(_b6d,date);
}});
}
$(_b67).combo("textbox").parent().addClass("datebox");
$(_b67).datebox("initValue",opts.value);
function _b69(_b6e){
var opts=$(_b6e).datebox("options");
var _b6f=$(_b6e).combo("panel");
_b6f.unbind(".datebox").bind("click.datebox",function(e){
if($(e.target).hasClass("datebox-button-a")){
var _b70=parseInt($(e.target).attr("datebox-button-index"));
opts.buttons[_b70].handler.call(e.target,_b6e);
}
});
};
function _b6a(_b71){
var _b72=$(_b71).combo("panel");
if(_b72.children("div.datebox-button").length){
return;
}
var _b73=$("<div class=\"datebox-button\"><table cellspacing=\"0\" cellpadding=\"0\" style=\"width:100%\"><tr></tr></table></div>").appendTo(_b72);
var tr=_b73.find("tr");
for(var i=0;i<opts.buttons.length;i++){
var td=$("<td></td>").appendTo(tr);
var btn=opts.buttons[i];
var t=$("<a class=\"datebox-button-a\" href=\"javascript:;\"></a>").html($.isFunction(btn.text)?btn.text(_b71):btn.text).appendTo(td);
...
var cc=_b75.children("div.datebox-calendar-inner");
_b75.children()._outerWidth(_b75.width());
_b68.calendar.appendTo(cc);
_b68.calendar[0].target=_b74;
if(opts.panelHeight!="auto"){
var _b76=_b75.height();
_b75.children().not(cc).each(function(){
_b76-=$(this).outerHeight();
});
cc._outerHeight(_b76);
}
_b68.calendar.calendar("resize");
};
};
function _b77(_b78,q){
_b79(_b78,q,true);
};
function _b7a(_b7b){
var _b7c=$.data(_b7b,"datebox");
var opts=_b7c.options;
var _b7d=_b7c.calendar.calendar("options").current;
if(_b7d){
_b79(_b7b,opts.formatter.call(_b7b,_b7d));
$(_b7b).combo("hidePanel");
}
};
function _b79(_b7e,_b7f,_b80){
var _b81=$.data(_b7e,"datebox");
var opts=_b81.options;
var _b82=_b81.calendar;
_b82.calendar("moveTo",opts.parser.call(_b7e,_b7f));
if(_b80){
$(_b7e).combo("setValue",_b7f);
}else{
if(_b7f){
_b7f=opts.formatter.call(_b7e,_b82.calendar("options").current);
}
$(_b7e).combo("setText",_b7f).combo("setValue",_b7f);
}
};
$.fn.datebox=function(_b83,_b84){
if(typeof _b83=="string"){
var _b85=$.fn.datebox.methods[_b83];
if(_b85){
return _b85(this,_b84);
}else{
return this.combo(_b83,_b84);
}
}
_b83=_b83||{};
return this.each(function(){
var _b86=$.data(this,"datebox");
if(_b86){
$.extend(_b86.options,_b83);
}else{
$.data(this,"datebox",{options:$.extend({},$.fn.datebox.defaults,$.fn.datebox.parseOptions(this),_b83)});
}
_b66(this);
});
};
$.fn.datebox.methods={options:function(jq){
var _b87=jq.combo("options");
return $.extend($.data(jq[0],"datebox").options,{width:_b87.width,height:_b87.height,originalValue:_b87.originalValue,disabled:_b87.disabled,readonly:_b87.readonly});
},cloneFrom:function(jq,from){
return jq.each(function(){
$(this).combo("cloneFrom",from);
...
},initValue:function(jq,_b88){
return jq.each(function(){
var opts=$(this).datebox("options");
var _b89=opts.value;
if(_b89){
_b89=opts.formatter.call(this,opts.parser.call(this,_b89));
}
$(this).combo("initValue",_b89).combo("setText",_b89);
});
},setValue:function(jq,_b8a){
return jq.each(function(){
_b79(this,_b8a);
});
},reset:function(jq){
...
$.fn.datebox.parseOptions=function(_b8b){
return $.extend({},$.fn.combo.parseOptions(_b8b),$.parser.parseOptions(_b8b,["sharedCalendar"]));
};
...
_b77(this,q);
}},currentText:"Today",closeText:"Close",okText:"Ok",buttons:[{text:function(_b8c){
return $(_b8c).datebox("options").currentText;
},handler:function(_b8d){
var now=new Date();
$(_b8d).datebox("calendar").calendar({year:now.getFullYear(),month:now.getMonth()+1,current:new Date(now.getFullYear(),now.getMonth(),now.getDate())});
_b7a(_b8d);
}},{text:function(_b8e){
return $(_b8e).datebox("options").closeText;
...
(function($){
function _b90(_b91){
var _b92=$.data(_b91,"datetimebox");
var opts=_b92.options;
$(_b91).datebox($.extend({},opts,{onShowPanel:function(){
var _b93=$(this).datetimebox("getValue");
_b99(this,_b93,true);
opts.onShowPanel.call(this);
},formatter:$.fn.datebox.defaults.formatter,parser:$.fn.datebox.defaults.parser}));
$(_b91).removeClass("datebox-f").addClass("datetimebox-f");
$(_b91).datebox("calendar").calendar({onSelect:function(date){
opts.onSelect.call(this.target,date);
}});
if(!_b92.spinner){
var _b94=$(_b91).datebox("panel");
var p=$("<div style=\"padding:2px\"><input></div>").insertAfter(_b94.children("div.datebox-calendar-inner"));
_b92.spinner=p.children("input");
}
_b92.spinner.timespinner({width:opts.spinnerWidth,showSeconds:opts.showSeconds,separator:opts.timeSeparator});
$(_b91).datetimebox("initValue",opts.value);
};
function _b95(_b96){
var c=$(_b96).datetimebox("calendar");
var t=$(_b96).datetimebox("spinner");
...
function _b9a(_b9b){
var opts=$.data(_b9b,"datetimebox").options;
var date=_b95(_b9b);
_b99(_b9b,opts.formatter.call(_b9b,date));
$(_b9b).combo("hidePanel");
};
function _b99(_b9c,_b9d,_b9e){
var opts=$.data(_b9c,"datetimebox").options;
$(_b9c).combo("setValue",_b9d);
if(!_b9e){
if(_b9d){
var date=opts.parser.call(_b9c,_b9d);
$(_b9c).combo("setText",opts.formatter.call(_b9c,date));
$(_b9c).combo("setValue",opts.formatter.call(_b9c,date));
}else{
$(_b9c).combo("setText",_b9d);
}
}
var date=opts.parser.call(_b9c,_b9d);
$(_b9c).datetimebox("calendar").calendar("moveTo",date);
$(_b9c).datetimebox("spinner").timespinner("setValue",_b9f(date));
function _b9f(date){
function _ba0(_ba1){
return (_ba1<10?"0":"")+_ba1;
};
var tt=[_ba0(date.getHours()),_ba0(date.getMinutes())];
if(opts.showSeconds){
tt.push(_ba0(date.getSeconds()));
}
return tt.join($(_b9c).datetimebox("spinner").timespinner("options").separator);
};
};
$.fn.datetimebox=function(_ba2,_ba3){
if(typeof _ba2=="string"){
var _ba4=$.fn.datetimebox.methods[_ba2];
if(_ba4){
return _ba4(this,_ba3);
}else{
return this.datebox(_ba2,_ba3);
}
}
_ba2=_ba2||{};
return this.each(function(){
var _ba5=$.data(this,"datetimebox");
if(_ba5){
$.extend(_ba5.options,_ba2);
}else{
$.data(this,"datetimebox",{options:$.extend({},$.fn.datetimebox.defaults,$.fn.datetimebox.parseOptions(this),_ba2)});
}
_b90(this);
});
};
$.fn.datetimebox.methods={options:function(jq){
var _ba6=jq.datebox("options");
return $.extend($.data(jq[0],"datetimebox").options,{originalValue:_ba6.originalValue,disabled:_ba6.disabled,readonly:_ba6.readonly});
},cloneFrom:function(jq,from){
return jq.each(function(){
...
},initValue:function(jq,_ba7){
return jq.each(function(){
var opts=$(this).datetimebox("options");
var _ba8=opts.value;
if(_ba8){
_ba8=opts.formatter.call(this,opts.parser.call(this,_ba8));
}
$(this).combo("initValue",_ba8).combo("setText",_ba8);
});
},setValue:function(jq,_ba9){
return jq.each(function(){
_b99(this,_ba9);
});
},reset:function(jq){
...
$.fn.datetimebox.parseOptions=function(_baa){
var t=$(_baa);
return $.extend({},$.fn.datebox.parseOptions(_baa),$.parser.parseOptions(_baa,["timeSeparator","spinnerWidth",{showSeconds:"boolean"}]));
};
...
_b97(this,q);
}},buttons:[{text:function(_bab){
return $(_bab).datetimebox("options").currentText;
},handler:function(_bac){
var opts=$(_bac).datetimebox("options");
_b99(_bac,opts.formatter.call(_bac,new Date()));
$(_bac).datetimebox("hidePanel");
}},{text:function(_bad){
return $(_bad).datetimebox("options").okText;
},handler:function(_bae){
_b9a(_bae);
}},{text:function(_baf){
return $(_baf).datetimebox("options").closeText;
...
function _bb1(_bb2){
return (_bb2<10?"0":"")+_bb2;
};
var _bb3=$(this).datetimebox("spinner").timespinner("options").separator;
var r=$.fn.datebox.defaults.formatter(date)+" "+_bb1(h)+_bb3+_bb1(M);
...
var _bb4=$(this).datetimebox("spinner").timespinner("options").separator;
var tt=dt[1].split(_bb4);
var hour=parseInt(tt[0],10)||0;
var _bb5=parseInt(tt[1],10)||0;
var _bb6=parseInt(tt[2],10)||0;
return new Date(d.getFullYear(),d.getMonth(),d.getDate(),hour,_bb5,_bb6);
}});
})(jQuery);
(function($){
function init(_bb7){
var _bb8=$("<div class=\"slider\">"+"<div class=\"slider-inner\">"+"<a href=\"javascript:;\" class=\"slider-handle\"></a>"+"<span class=\"slider-tip\"></span>"+"</div>"+"<div class=\"slider-rule\"></div>"+"<div class=\"slider-rulelabel\"></div>"+"<div style=\"clear:both\"></div>"+"<input type=\"hidden\" class=\"slider-value\">"+"</div>").insertAfter(_bb7);
var t=$(_bb7);
t.addClass("slider-f").hide();
var name=t.attr("name");
if(name){
_bb8.find("input.slider-value").attr("name",name);
t.removeAttr("name").attr("sliderName",name);
}
_bb8.bind("_resize",function(e,_bb9){
if($(this).hasClass("easyui-fluid")||_bb9){
_bba(_bb7);
}
return false;
});
...
function _bba(_bbb,_bbc){
var _bbd=$.data(_bbb,"slider");
var opts=_bbd.options;
var _bbe=_bbd.slider;
if(_bbc){
if(_bbc.width){
opts.width=_bbc.width;
}
if(_bbc.height){
opts.height=_bbc.height;
}
}
_bbe._size(opts);
if(opts.mode=="h"){
_bbe.css("height","");
_bbe.children("div").css("height","");
}else{
_bbe.css("width","");
_bbe.children("div").css("width","");
_bbe.children("div.slider-rule,div.slider-rulelabel,div.slider-inner")._outerHeight(_bbe._outerHeight());
}
_bbf(_bbb);
};
function _bc0(_bc1){
var _bc2=$.data(_bc1,"slider");
var opts=_bc2.options;
var _bc3=_bc2.slider;
...
_bc4(aa);
function _bc4(aa){
var rule=_bc3.find("div.slider-rule");
var _bc5=_bc3.find("div.slider-rulelabel");
rule.empty();
_bc5.empty();
for(var i=0;i<aa.length;i++){
var _bc6=i*100/(aa.length-1)+"%";
var span=$("<span></span>").appendTo(rule);
span.css((opts.mode=="h"?"left":"top"),_bc6);
if(aa[i]!="|"){
span=$("<span></span>").appendTo(_bc5);
span.html(aa[i]);
if(opts.mode=="h"){
span.css({left:_bc6,marginLeft:-Math.round(span.outerWidth()/2)});
}else{
span.css({top:_bc6,marginTop:-Math.round(span.outerHeight()/2)});
}
}
}
};
...
function _bc7(_bc8){
var _bc9=$.data(_bc8,"slider");
var opts=_bc9.options;
var _bca=_bc9.slider;
_bca.removeClass("slider-h slider-v slider-disabled");
_bca.addClass(opts.mode=="h"?"slider-h":"slider-v");
_bca.addClass(opts.disabled?"slider-disabled":"");
var _bcb=_bca.find(".slider-inner");
_bcb.html("<a href=\"javascript:;\" class=\"slider-handle\"></a>"+"<span class=\"slider-tip\"></span>");
if(opts.range){
_bcb.append("<a href=\"javascript:;\" class=\"slider-handle\"></a>"+"<span class=\"slider-tip\"></span>");
}
_bca.find("a.slider-handle").draggable({axis:opts.mode,cursor:"pointer",disabled:opts.disabled,onDrag:function(e){
...
_bc9.isDragging=true;
opts.onSlideStart.call(_bc8,opts.value);
},onStopDrag:function(e){
_bcd(opts.mode=="h"?e.data.left:e.data.top,this);
opts.onSlideEnd.call(_bc8,opts.value);
opts.onComplete.call(_bc8,opts.value);
_bc9.isDragging=false;
}});
_bca.find("div.slider-inner").unbind(".slider").bind("mousedown.slider",function(e){
if(_bc9.isDragging||opts.disabled){
return;
}
var pos=$(this).offset();
_bcd(opts.mode=="h"?(e.pageX-pos.left):(e.pageY-pos.top));
opts.onComplete.call(_bc8,opts.value);
});
function _bcd(pos,_bce){
var _bcf=_bd0(_bc8,pos);
var s=Math.abs(_bcf%opts.step);
if(s<opts.step/2){
_bcf-=s;
}else{
_bcf=_bcf-s+opts.step;
}
if(opts.range){
var v1=opts.value[0];
var v2=opts.value[1];
...
if(_bce){
var _bd1=$(_bce).nextAll(".slider-handle").length>0;
if(_bcf<=v2&&_bd1){
v1=_bcf;
}else{
if(_bcf>=v1&&(!_bd1)){
...
_bcf<m?v1=_bcf:v2=_bcf;
}
}
}
$(_bc8).slider("setValues",[v1,v2]);
}else{
$(_bc8).slider("setValue",_bcf);
}
};
};
function _bd2(_bd3,_bd4){
var _bd5=$.data(_bd3,"slider");
var opts=_bd5.options;
var _bd6=_bd5.slider;
var _bd7=$.isArray(opts.value)?opts.value:[opts.value];
var _bd8=[];
if(!$.isArray(_bd4)){
_bd4=$.map(String(_bd4).split(opts.separator),function(v){
return parseFloat(v);
});
}
_bd6.find(".slider-value").remove();
var name=$(_bd3).attr("sliderName")||"";
for(var i=0;i<_bd4.length;i++){
var _bd9=_bd4[i];
if(_bd9<opts.min){
_bd9=opts.min;
}
...
var _bda=$("<input type=\"hidden\" class=\"slider-value\">").appendTo(_bd6);
_bda.attr("name",name);
_bda.val(_bd9);
_bd8.push(_bd9);
var _bdb=_bd6.find(".slider-handle:eq("+i+")");
var tip=_bdb.next();
var pos=_bdc(_bd3,_bd9);
if(opts.showTip){
tip.show();
tip.html(opts.tipFormatter.call(_bd3,_bd9));
}else{
tip.hide();
}
if(opts.mode=="h"){
var _bdd="left:"+pos+"px;";
_bdb.attr("style",_bdd);
tip.attr("style",_bdd+"margin-left:"+(-Math.round(tip.outerWidth()/2))+"px");
}else{
var _bdd="top:"+pos+"px;";
_bdb.attr("style",_bdd);
tip.attr("style",_bdd+"margin-left:"+(-Math.round(tip.outerWidth()))+"px");
}
}
opts.value=opts.range?_bd8:_bd8[0];
$(_bd3).val(opts.range?_bd8.join(opts.separator):_bd8[0]);
if(_bd7.join(",")!=_bd8.join(",")){
opts.onChange.call(_bd3,opts.value,(opts.range?_bd7:_bd7[0]));
}
};
function _bbf(_bde){
var opts=$.data(_bde,"slider").options;
var fn=opts.onChange;
opts.onChange=function(){
};
_bd2(_bde,opts.value);
opts.onChange=fn;
};
function _bdc(_bdf,_be0){
var _be1=$.data(_bdf,"slider");
var opts=_be1.options;
var _be2=_be1.slider;
var size=opts.mode=="h"?_be2.width():_be2.height();
var pos=opts.converter.toPosition.call(_bdf,_be0,size);
if(opts.mode=="v"){
pos=_be2.height()-pos;
}
if(opts.reversed){
...
var _be6=opts.converter.toValue.call(_be3,pos,size);
return _be6.toFixed(0);
};
$.fn.slider=function(_be7,_be8){
if(typeof _be7=="string"){
return $.fn.slider.methods[_be7](this,_be8);
}
_be7=_be7||{};
return this.each(function(){
var _be9=$.data(this,"slider");
if(_be9){
$.extend(_be9.options,_be7);
}else{
_be9=$.data(this,"slider",{options:$.extend({},$.fn.slider.defaults,$.fn.slider.parseOptions(this),_be7),slider:init(this)});
$(this).removeAttr("disabled");
}
...
_bd2(this,opts.range?[opts.min,opts.max]:[opts.min]);
});
},reset:function(jq){
return jq.each(function(){
var opts=$(this).slider("options");
...
$.fn.slider.parseOptions=function(_bed){
var t=$(_bed);
return $.extend({},$.parser.parseOptions(_bed,["width","height","mode",{reversed:"boolean",showTip:"boolean",range:"boolean",min:"number",max:"number",step:"number"}]),{value:(t.val()||undefined),disabled:(t.attr("disabled")?true:undefined),rule:(t.attr("rule")?eval(t.attr("rule")):undefined)});
};
$.fn.slider.defaults={width:"auto",height:"auto",mode:"h",reversed:false,showTip:false,disabled:false,range:false,value:0,separator:",",min:0,max:100,step:1,rule:[],tipFormatter:function(_bee){
return _bee;
},converter:{toPosition:function(_bef,size){
var opts=$(this).slider("options");
return (_bef-opts.min)/(opts.max-opts.min)*size;
},toValue:function(pos,size){
var opts=$(this).slider("options");
return opts.min+(opts.max-opts.min)*(pos/size);
}},onChange:function(_bf0,_bf1){
},onSlideStart:function(_bf2){
},onSlideEnd:function(_bf3){
},onComplete:function(_bf4){
}};
})(jQuery);
