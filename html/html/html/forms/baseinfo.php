...
if ($c_response->errno != 0){
	...
	$_SESSION['email'] = $result[$i]->me['struct']['mobile']->me['string'];
	$_SESSION['shift type'] = $result[$i]->me['struct']['email']->me['string'];
	$_SESSION['louve status'] = $result[$i]->me['struct']['cooperative_state']->me['string'];
