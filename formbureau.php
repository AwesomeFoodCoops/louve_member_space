...
<div class="container">
	...
	<?php if ($_SESSION['posted'] == 214)
      ...
      <form class="form-signin" method="post" action="messagetobureau.php">
        ...
        <input type="text" id="title" name="message" class="form-control" placeholder="Entrez votre message ici" autofocus>
        <p></p>
